...
from algorithms.verl_trace2skill.trajectory import build_trajectory_records, write_trajectory_records
        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                with marked_timer("step", timing_raw):
                    ...
                    # Persist completed rollouts before the optimizer update.  Besides
                    # making the dump describe the exact batch used for learning, this
                    # keeps long multi-turn traces available when a later actor update
                    # fails (for example during a memory-capacity smoke test).
