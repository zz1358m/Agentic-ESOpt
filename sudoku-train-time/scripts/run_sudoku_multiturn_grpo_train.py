...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=int,
        default=int(os.environ.get("SUDOKU_GRPO_MAX_POLICY_EXAMPLES", "512")),
        help="Global policy mini-batch size. All full mini-batches are updated; only the final remainder is dropped.",
    )
