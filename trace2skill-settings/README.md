...
```bash
python trace2skill-settings/scripts/prepare_data.py --setting all
```

Useful smoke tests:

```bash
python trace2skill-settings/scripts/prepare_data.py --setting math_reasoning --limit 20
python trace2skill-settings/scripts/prepare_data.py --setting docvqa --limit 60
```
...
```bash
python trace2skill-settings/scripts/prepare_data.py \
  --setting docvqa \
...
```bash
python trace2skill-settings/scripts/evolve_from_trace_logs.py \
