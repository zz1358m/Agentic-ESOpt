...
class AsyncEngine(sglang.srt.entrypoints.engine.Engine):
    ...
    async def release_memory_occupation(self, tags: Optional[list[str]] = None):
        ...
        if tags is None:
            ...
            print("Release Memory Occupation Request Input")
            print(tags)
            # obj = ReleaseMemoryOccupationReqInput()
    ...
    async def resume_memory_occupation(self, tags: Optional[list[str]] = None):
        ...
        if tags is None:
            ...
            print("Resume Memory Occupation Request Input")
            print(tags)
            # obj = ResumeMemoryOccupationReqInput()
...
class SGLangRollout(BaseRollout):
    ...
    def _init_inference_engine(self, trust_remote_code, actor_module, port):
        ...
        if effective_first:
            ...
            args = {
                ...
                "max_topk": self.config.get("max_topk", 15),
    ...
    def _init_sampling_params(self, **kwargs):
        kwargs = dict(
            ...
            after_thinking_top_k=self.config.get("after_thinking_top_k", 30),
            after_thinking_min_p=self.config.get("after_thinking_min_p", 0.0),
            think_end_str=self.config.get("think_end_str", '</think>'),
            gumbel_softmax_temperature=self.config.get("gumbel_softmax_temperature", 0.5),
